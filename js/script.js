// Variable for unordered list where player's guessed letters will appear
const guessedLettersElement = document.querySelector(".guessed-letters");
// Variable for the button with the text "Guess!"
const guessLetterButton = document.querySelector(".guess");
// Variable for the text input where the player will guess a letter
